# Alimentando um DB pra gerenciar uma consulta no DB
...
#Crinado agora o programa: que vai inserir dados na Tabela e que ira consultar.

#importadno a biblioteca sqlite3
import sqlite3 
#Função para conectar ao DB
def conectar_banco(nome_banco):
    conexao = sqlite3.connect(nome_banco)
    return conexao
#Função criar tabela no DB
...
#Função para requisitar e imprimir as requisições
...
#Chamar metodo e finalizar tudo
